...
public class StageManager {
    ...
    public void showWindows(MainService mainService){
    ...
    public void showLoginWindow(Stage stage, MainService mainService) {
        Tuple<Scene, controllers.LoginController> tuple = FXMLUtil.load("/view/loginWindow.fxml");
        tuple.getSecond().setMainService(mainService);
        Scene scene = tuple.getFirst();
        stage.setScene(scene);
        stage.centerOnScreen();
