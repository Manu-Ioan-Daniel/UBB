-- Flocks
INSERT INTO flocks (flockId, flockName) VALUES (1, 'Flying Masters');
INSERT INTO flocks (flockId, flockName) VALUES (2, 'Swimming Squad');
...
VALUES (1, 'FLYING', 10.0, 8.0);
INSERT INTO ducks (userId, duckType, duckSpeed, duckRezistance)
VALUES (2, 'FLYING', 9.5, 7.5);
INSERT INTO ducks (userId, duckType, duckSpeed, duckRezistance)
VALUES (3, 'SWIMMING', 8.0, 9.0);
INSERT INTO ducks (userId, duckType, duckSpeed, duckRezistance)
VALUES (4, 'SWIMMING', 7.5, 8.5);
