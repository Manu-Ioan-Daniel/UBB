...
public class DatabaseUserRepository {
    ...
    public void deleteUser(String username) {
        if (!usernameExists(username)) {
            throw new RepoError("User with id " + username + " does not exist.");
        }
        try (Connection connection = DriverManager.getConnection(databaseURL)) {
    ...
    public void addFriend(String username, String friendUsername) {
        if (friendExists(username, friendUsername)) {
            throw new RepoError("Friendship between user " + username + " and friendUsername " + friendUsername + " already exists.");
        }
    ...
    public void removeFriend(String username,String friendUsername) {
        if (!friendExists(username,friendUsername)) {
            throw new RepoError("Friendship between user " + username + " and friend " + friendUsername + " does not exist.");
        }
    ...
    private boolean friendExists(String username1, String username2) {
        try (Connection connection = DriverManager.getConnection(databaseURL)) {
            String sql = "SELECT 1 FROM userfriends uf " +
        ...
        try (Connection connection = DriverManager.getConnection(databaseURL)) {
            ...
            if (rs.next()) {
                ...
                if (rs.getString("duckType") != null) {
                    Duck duck = new Duck(id, username, email, password,
                            DuckType.valueOf(rs.getString("duckType")),
                            rs.getDouble("duckSpeed"),
                            rs.getDouble("duckRezistance"));
                    return duck;
