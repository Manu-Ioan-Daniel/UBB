secv([],0,[],0,[]):-!.
secv([H1,H2|T],LungimeCur,[H1,H2|ListaCurT],LungimeMax,ListaMax):-
    H1 mod 2 =:= 0,
    H2 mod 2 =:= 0,
    secv(T,LungimeCurT,ListaCurT,LungimeMaxT,ListaMaxT),
    LungimeCur is LungimeCurT + 2,
    (LungimeCur>LungimeMaxT -> LungimeMax=LungimeCur,ListaMax=[H1,H2|ListaCurT];LungimeMax=LungimeMaxT,ListaMax=ListaMaxT),!.
