...
public class SearchFormController {
    ...
    public void initTable(){
        noSeatColumn.setCellValueFactory(cell -> {
            RideDTO dto = cell.getValue();
            return new javafx.beans.property.ReadOnlyObjectWrapper<>(dto != null ? dto.getNoSeats() : 0);
        });
        reservedByColumn.setCellValueFactory(cell -> {
            RideDTO dto = cell.getValue();
            return new javafx.beans.property.SimpleStringProperty(dto != null ? dto.getReservedBy() : "");
        });
    }
}
