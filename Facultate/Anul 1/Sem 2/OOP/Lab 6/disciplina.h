...
class Disciplina {
    ...
    public:
        ...
        Disciplina::Disciplina(string denumire, const int nrOre, string tip, string cadruDidactic):denumire{std::move(denumire)},nrOre{nrOre},tip{std::move(tip)},cadruDidactic{std::move(cadruDidactic)} {
